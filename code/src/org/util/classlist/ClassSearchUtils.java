...
/**
 * Original source code from: http://www.java2s.com/Tutorial/Java/0180__File/SearchclassinclasspathandJarfiles.htm . 
 * Code adapted by Piero Dalle Pezze in order to just print the classes instead of loading the them.
 */
public class ClassSearchUtils {
	 ...
	 * @param prefix The package prefix to search in.
