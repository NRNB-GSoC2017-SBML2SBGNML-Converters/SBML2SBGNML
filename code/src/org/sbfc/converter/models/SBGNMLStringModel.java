/*
 * $Id: SBGNMLStringModel.java 390 2015-07-09 13:29:56Z pdp10 $
 * $URL: svn+ssh://niko-rodrigue@svn.code.sf.net/p/sbfc/code/trunk/src/org/sbfc/converter/models/SBGNMLStringModel.java $
 *
 * ==========================================================================
...
public class SBGNMLStringModel extends StringModel {
	
	@Override
	public String[] getExtensions() {
		return new String[] { ".xml", ".sbgnml", ".sbgn" }; // .xml is preferred.
	}
